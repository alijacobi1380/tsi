...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.editusercheck', ['id' => $user->id]) }}" method="POST">
                        @csrf
                        ...
                        <button type="submit"
                            class="btn col-12 btn-info waves-effect waves-light">{{ __('messages.adedituserbtn') }}</button>
...
@section('pagetitle')
    {{ __('messages.adedituserpagetitle') }} {{ $user->name }}
@endsection
