                        ...
                        @switch($vitrin->status)
                            @case(0)
                                <div class="alert alert-info mb-0" role="alert">
                                    {{ __('messages.vitrinstatuswait') }}
                                </div>
                            @break

                            @case(1)
                                <div class="alert alert-success" role="alert">
                                    {{ __('messages.vitrinstatusok') }}
                                </div>
                            @break
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form id="form" action="{{ route('producer.addvitrincheck') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select name="size" class="form-control">
                                                                <option value="1">{{ __('messages.vtsize1') }}
                                                                </option>
                                                                <option value="2">{{ __('messages.vtsize2') }}
                                                                </option>
                                                                <option value="3">{{ __('messages.vtsize3') }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
